        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs text-neutral-400 leading-relaxed max-w-sm mt-3">
              Madhav Enterprise is a premier manufacturer and supplier of Automatic Water Level Controllers, Butterfly Valves, Sewage Dewatering Pumps, Submersible Pumps, and Hydro Booster Systems based in Diwalipura, Vasna Road, Vadodara, Gujarat.
            </p>
